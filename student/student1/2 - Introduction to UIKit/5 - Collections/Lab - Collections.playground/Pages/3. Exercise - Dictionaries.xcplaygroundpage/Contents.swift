...
let shapesColorsDictionary: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
print(shapesColorsDictionary)
...
if let lastColor = shapesColorsDictionary["Colors"]?.last {
    print(lastColor)
}

print(shapesColorsDictionary["Colors"]!.last!)
/*:
