...
let friendsAndFamily : [String] = ["John", "Jane", "Mary", "Bob"]
let sortedCollection1: [String] = friendsAndFamily.sorted(by: forwards)
...
let sortedCollection2: [String] = friendsAndFamily.sorted(by: { (name1: String, name2: String) -> Bool in
    print("\(name1)")
    print("\(name2)")
    return name1 < name2
})
...
let sortedCollection3: [String] = friendsAndFamily.sorted {
    print("\($0)")
    print("\($1)")
    return $0 > $1
}
