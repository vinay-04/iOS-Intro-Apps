...
challenges.append(["Walk 3 miles a day", "Run 5 times a week", "Swim 100 yards a day", "Cycle 10 miles a week"])
...
if userCommittedChallenges.isEmpty {
    userCommittedChallenges.append("Walk 3 miles a day")
    
} else if userCommittedChallenges.count == 1 {
    userCommittedChallenges.append("Swim 100 yards a day")
}
else{
    userCommittedChallenges.append(
        "mehh, I'm not feeling it"
    )
}
/*:
