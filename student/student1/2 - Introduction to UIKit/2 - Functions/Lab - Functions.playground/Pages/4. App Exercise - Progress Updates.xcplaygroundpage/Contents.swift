...
func progressUpdate(steps: Double, goal: Double) {
    ...
    } else if steps < 0.5 * goal {
        print("You're almost halfway there!")
    } else if steps < 0.9 * goal {
...
pacing(currentDistance: 10, totalDistance: 20, currentTime: 2, goalTime: 4)
/*:
