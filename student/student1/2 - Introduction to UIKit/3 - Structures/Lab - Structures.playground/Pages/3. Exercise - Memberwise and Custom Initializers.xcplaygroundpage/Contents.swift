...
var favoriteBook = Book(title: "The Alchemist", author: "Paulo Coelho", pages: 100, price: 20.00)
...
var laptop1 = Laptop(screenSize: 13, repairCount: 0, yearPurchased: 2018)
var laptop2 = Laptop(yearPurchased: 2019)
print("My laptop is \(laptop1.screenSize) inches, \(laptop1.repairCount) repairs, and was purchased in \(laptop1.yearPurchased)")
print("My laptop is \(laptop2.screenSize) inches, \(laptop2.repairCount) repairs, and was purchased in \(laptop2.yearPurchased)")
/*:
...
struct Height {
    ...
    init(heightInCentimeters: Double) {
        ...
        self.init(heightInInches: inches)
    }
}
