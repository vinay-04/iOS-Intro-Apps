 ...
 */
struct User {
    static var currentUser = User(userName: "John", email: "john@email.com", age: 23)
    var userName: String
    var email: String
    var age: Int
...
var user2 = User(userName: "James", email: "james@email.com", age: 23)
 ...
 */
print(User.currentUser.userName)
User.logIn(user: User(userName: "James", email: "james@email.com", age: 23))
print(User.currentUser.userName)
